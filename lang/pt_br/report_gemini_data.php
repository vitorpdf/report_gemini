...
// Nome do plugin (exibido no menu "Relatórios").
$string['pluginname']        = 'Relatórios de Dados Gemini';
$string['gemini_data:view']  = 'Visualizar Relatórios de Dados Gemini';

// Título / cabeçalho da página.
$string['pagetitle']         = 'Relatórios de Dados Gemini';
$string['pageheading']       = 'Relatórios de Dados com IA';
$string['pagedescription']   = 'Escolha uma consulta pré-definida abaixo e clique em <strong>Gerar Relatório</strong> para buscar dados estruturados do Google Gemini IA.';

// Rótulos dos presets.
$string['preset_countries']  = 'Países e suas populações';
$string['preset_states']     = 'Estados do Brasil e datas de fundação';
...
// Status / erros.
$string['errornoapikey']     = 'A chave de API do Gemini não está configurada. Solicite ao administrador que a configure em Administração do site → Plugins → Relatórios → Relatórios de Dados Gemini.';
...
$string['temperature_desc']      = 'Controla a criatividade das respostas. 0,0 = determinístico, 1,0 = criativo.';
